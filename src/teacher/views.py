...
from teacher.forms import TeacherForm, SearchTeacherForm
# from tags.models import ViewTeacherRecord
# from tags.views import FavTeacher
# from billing.views import creditstart
...
class TeacherList(ListView, FormView):
    ...
    def get_queryset(self, *args, **kwargs):
        qs = super(TeacherList, self).get_queryset().distinct().order_by('-date_modified')
        ...
        subject_obj = Subject_Expertise.objects.filter(id=subject).first() if subject else None
        ...
        if search:
            ...
            try:
                ...
                test = self.request.user.student
                from tags.models import SearchWordTeacherRecord
